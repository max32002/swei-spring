...
@font-face {
  ...
  src: url(https://github.com/max32002/swei-spring/raw/master/WebFont/CJK%20TC/SweiSpringCJKtc-Regular.woff2) format("woff2")
  , url(https://github.com/max32002/swei-spring/raw/master/WebFont/CJK%20TC/SweiSpringCJKtc-Regular.woff) format("woff");
}
```
